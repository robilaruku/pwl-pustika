...
<div class="card">
    ...
    <div class="card-body">
        ...
        <?php endif; ?>
        <!-- Styled Form -->
        <form action="/admin-genre/update/<?php echo $genre['id']; ?>" method="POST">
            <input type="hidden" name="_token" value="<?php echo htmlspecialchars($csrfToken); ?>">
            <label for="nama">Nama:</label>
            <input type="text" id="nama" name="nama" placeholder="Nama Genre"
                value="<?php echo htmlspecialchars($genre['nama']); ?>" required>
